...
echo -e "${BLUE}• Start Exercise:${NC} cd labspace-exercises/quota-mystery && cat README.md"
echo -e "${BLUE}• Investigation Guide:${NC} cat labspace-exercises/quota-mystery/tse-investigation/README.md"
echo -e "${BLUE}• Diagnostic Commands:${NC} curl http://localhost:8080/v1/health"
echo -e "${BLUE}• View Lab Structure:${NC} find labspace-exercises -type f | head -10"
echo ""
